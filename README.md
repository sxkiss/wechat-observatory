...
- 默认产物：`wechat-observatory-android-apk`
- Release 文件命名：`wechat-observatory-android-<tag>-<signed|debug>.apk`
- 如果提供签名 Secrets，会输出已签名 release APK；否则自动回退为可安装的 debug APK
